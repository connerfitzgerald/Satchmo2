...
class ConfirmController(object):
    ...
    def _onSuccess(self, controller):
        ...
        if controller.order.paid_in_full:
            ...
            u1= User.objects.get(username= self.request.user)
            print u1.id
...
#            print Book
            ...
            try:
                UP123= UserProfile.objects.get(user=u1)
            except:
                UP123= UserProfile.objects.create(user=u1)
            
            TempVP= ViewingPermission(BookKey=Book, person=UP123, date ="1000-11-11")
#            print TempVP.BookKey
#            print TempVP.person
#            print TempVP.date
