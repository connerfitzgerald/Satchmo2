...
from store.pricingProfiles.models import *
...
class Product(models.Model):
    ...
    pricingList = models.ForeignKey(PriceList, verbose_name=_('Pricing Option'), null=True, blank=True)
    slug = models.SlugField(_("Slug Name"), blank=True,
        help_text=_("Used for URLs, auto-generated from name if blank"), max_length=255)
    slugFile = models.SlugField(_("SlugFile"), help_text=_(" Location where the actual data is stored?"), blank=True)
    ...
    shipclass = models.CharField(_('Shipping'), choices=SHIP_CLASS_CHOICES, default="NO", max_length=10,
